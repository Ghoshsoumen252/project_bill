...
public class Insproduct extends HttpServlet {
	...
	try {
		...
		String sql="INSERT INTO products SET product_id='"+i+"',product_name='"+pn+"',product_price='"+pp+"',product_hsnc='"+hsnc+"',product_cgst='"+cgst+"',product_sgst='"+sgst+"',product_barcode='"+barcode+"'";
